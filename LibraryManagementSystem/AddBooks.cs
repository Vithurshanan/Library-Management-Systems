    ...
    public partial class AddBooks : UserControl
    {
        ...
        private void addBooks_importBtn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                dialog.Filter = "Iamge Files (*.jpg; *.png ) | *.jpg; *.png ";
        ...
        private void addBooks_bookTitle_TextChanged(object sender, EventArgs e)
        {
            // Add your logic here, or leave it empty if no specific action is required.
        }


        private void addBooks_addBtn_Click(object sender, EventArgs e)
        {
            if(addBooks_picture.Visible)
            {
                ...
                else
                {
                    if (connect.State == ConnectionState.Closed)
                    {
                        try
                        {
                            ...
                            string path = Path.Combine(@"C:\Users\Admin User\source\repos\LibraryManagementSystem\LibraryManagementSystem\Books_Directory\" +
                ...
                if (connect.State != ConnectionState.Open)
                {
                    ...
                    if (check == DialogResult.Yes)
                    {
                        try
                        {
                            connect.Open();
                            DateTime today = DateTime.Today;
                            string updateData = "UPDATE books SET books_title = @bookTitle" +
